...
window.onload = function () {
  ...
  function fillQuestions() {
    ...
    questions_je = [
      ...
      'Elovasom és megértem a parancsot, majd kiválasztom a nagy zöld karikát.',
    ...
    questions_jk = [
      ...
      'Kiválasztom a nagy zöld karikát.',
  ...
  function updateImage() {
    // Question 22 (end screen after question 21) has index 23
  ...
  function displayQuestion() {
    ...
    if (questionNumber <= 22) {
      ...
      if (currentScore == -44) {
        ...
        text = 'Gratulálok! Megtaláltad az Igazságot. A Végső Igazságot, mely üreges és semmitmondó. Ez a végtelen űr: ez maga a tökéletesség. Ebben a tökéletes ürességben viszhangzanak a bukásaid: örökké és megmásíthatatlanul. Hajolj meg az üresség előtt: ez az alázat lesz méltóságod forrása! Hajolj meg az üresség előtt: mert ez maga a szabadság!  Hajolj meg az üresség előtt: hogy valódi társa légy! Most egyenesedj fel. Ha figyelemmel végezted a rituálét, akkor most átestél az első beavatáson: a rád bízott lélek szabaddá lett és visszatért hozzád.'
      }
